...
- Testbasierte Entwicklung (TDD) in TypeScript + NestJS, PHP und Go
...
`,
  },
  {
    ...
    time: '2016 - 2021',
    description: `
Exposify war eine benutzerfreundliche Maklersoftware für mittelständige Immobilienunternehmen. Ich bin Mitgründer von dem Startup hinter Exposify. Aus den gesammelten Erfahrungen ist später unser API-Service EstateSync entstanden.
...
- Nutzung verschiedener Grafik-Tools: Photoshop, Affinity Desginer, Figma
`,
  },
]
